...
| 最新 commit | fix-admin-users-page-flaky-test 归档(CH-3 归档后会刷新) |
...
## 2. 本次 session 关键决策(2026-04-24,`config-llm-timeout-default` propose+apply+archive + E2E 验证 3 供应商 zip 暴露 8 类问题)
