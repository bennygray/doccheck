...
| 最新 commit | `归档 change: detect-tender-baseline(M5)`(本次 commit,§1–§9 全部 [x] + 移目录到 `openspec/changes/archive/2026-04-30-detect-tender-baseline/`) |
