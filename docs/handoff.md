...
| 最新 commit | config-llm-timeout-default 归档(CH-1 归档后会刷新) |
...
## 2. 本次 session 关键决策(2026-04-25,`parser-accuracy-fixes` CH-1 propose+apply+archive + 2 轮独立 reviewer)
